...
**Date:** 2026-07-15  
**Category:** Web, Server  
**Skills used:** XSS exploitation

## Overview
Cross-Site Scripting (XSS) is a web that allows an attacker to inject malacious code into a trusted website. When another user visits the affected page, the malacious script runs in their browser as if it came form the legitimate website.
