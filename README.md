...
- [Kestrel: SSRF to Root](tryhackme/ctf-writeups/thm-ctf-operation-coldstart.md) — anonymous FTP source disclosure, SSRF via URL-validation bypass, and Tar Wildcard Injection for root
